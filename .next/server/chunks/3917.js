...
// EXTERNAL MODULE: ./app/components/mask.tsx + 2 modules
var mask = __webpack_require__(83891);
...
function MessageSelector(props) {
    ...
    const isValid = (m)=>m.content && !m.streaming;
    const messages = session.messages.filter((m, i)=>m?._id && // message must have id
    ...
    const doSearch = (text)=>{
        ...
        if (text.length > 0) {
            messages.forEach((m)=>m.content.includes(text) ? searchResults.add(m?._id) : null);
        }
    ...
    const selectAll = ()=>{
        props.updateSelection((selection)=>messages.forEach((m)=>selection.add(m?._id)));
    };
    (0,react_.useEffect)(()=>{
        ...
        children: [
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
                                ...
                                onClick: ()=>props.updateSelection((selection)=>{
                                        selection.clear();
                                        messages.slice(messageCount - LATEST_COUNT).forEach((m)=>selection.add(m?._id));
                                    })
                            }),
                            /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: messages.map((m, i)=>{
                    ...
                    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        className: `${(message_selector_module_default()).message} ${props.selection.has(m?._id) && (message_selector_module_default())["message-selected"]}`,
                        onClick: ()=>{
                            props.updateSelection((selection)=>{
                                const id = m?._id ?? i;
                        ...
                        children: [
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                ...
                                }) : /*#__PURE__*/ jsx_runtime_.jsx(mask.MaskAvatar, {
                                    mask: session.mask
                                })
                            }),
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
...
const Markdown = app_dynamic_default()(async ()=>(await Promise.all(/* import() */[__webpack_require__.e(4), __webpack_require__.e(9246)]).then(__webpack_require__.bind(__webpack_require__, 9246))).Markdown, {
    loadableGenerated: {
        modules: [
            "/Users/zhangdezhi/Documents/project/chatgpt/app/components/exporter.tsx -> " + "./markdown"
        ]
    },
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            currentStep.value === "preview" && /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: (exporter_module_default())["message-exporter-body"],
                children: exportConfig.format === "text" ? /*#__PURE__*/ jsx_runtime_.jsx(MarkdownPreviewer, {
                    messages: selectedMessages,
                    topic: session.topic
                }) : /*#__PURE__*/ jsx_runtime_.jsx(ImagePreviewer, {
                    messages: selectedMessages,
                    topic: session.topic
                })
            })
...
const chat_Markdown = app_dynamic_default()(async ()=>(await Promise.all(/* import() */[__webpack_require__.e(4), __webpack_require__.e(9246)]).then(__webpack_require__.bind(__webpack_require__, 9246))).Markdown, {
    loadableGenerated: {
        modules: [
            "/Users/zhangdezhi/Documents/project/chatgpt/app/components/chat.tsx -> " + "./markdown"
        ]
    },
    loading: ()=>/*#__PURE__*/ jsx_runtime_.jsx(three_dots/* default */.Z, {})
});
function SessionConfigModel(props) {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* Modal */.u_, {
            ...
            children: /*#__PURE__*/ jsx_runtime_.jsx(mask.MaskConfig, {
                mask: session.mask,
                updateMask: (updater)=>{
                    const mask = {
                        ...session.mask
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(ui_lib/* Modal */.u_, {
            ...
            children: [
                ...
                /*#__PURE__*/ jsx_runtime_.jsx(mask.ContextPrompts, {
                    context: messages,
...
function _Chat() {
    ...
    const onUserStop = (messageId)=>{
        controller/* ChatControllerPool */.L.stop(session._id, messageId);
    };
    ...
    const deleteMessage = (msgId)=>{
        chatStore.updateCurrentSession((session)=>session.messages = session.messages.filter((m)=>m._id !== msgId));
    };
    ...
    const onResend = (message)=>{
        ...
        const resendingIndex = session.messages.findIndex((m)=>m._id === message._id);
                                                        ...
                                                        /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                            ...
                                                            children: /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
                                                                ...
                                                                onClick: async ()=>{
                                                                    ...
                                                                    chatStore.updateCurrentSession((session)=>{
                                                                        const m = session.messages.find((m)=>m._id === message._id);
                                                                        if (m) {
