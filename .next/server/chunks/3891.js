...
;// CONCATENATED MODULE: ./app/components/model-config.tsx
/*
 * :file description: 
 * :name: /chatgpt/app/components/model-config.tsx
 * :author: 张德志
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* ListItem */.HC, {
                title: locales/* default */.ZP.Settings.Temperature.Title,
                subTitle: locales/* default */.ZP.Settings.Temperature.SubTitle,
                children: /*#__PURE__*/ jsx_runtime_.jsx(input_range/* InputRange */.O, {
                    ...
                    step: "0.1",
                    onChange: (e)=>{
                        props.updateConfig((config)=>config.temperature = store/* ModalConfigValidator */.Xm.temperature(e.currentTarget.valueAsNumber));
                    }
                })
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* ListItem */.HC, {
                title: locales/* default */.ZP.Settings.TopP.Title,
                subTitle: locales/* default */.ZP.Settings.TopP.SubTitle,
                children: /*#__PURE__*/ jsx_runtime_.jsx(input_range/* InputRange */.O, {
                    ...
                    step: "0.1",
                    onChange: (e)=>{
                        props.updateConfig((config)=>config.top_p = store/* ModalConfigValidator */.Xm.top_p(e.currentTarget.valueAsNumber));
                    }
                })
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* ListItem */.HC, {
                title: locales/* default */.ZP.Settings.MaxTokens.Title,
                subTitle: locales/* default */.ZP.Settings.MaxTokens.SubTitle,
                children: /*#__PURE__*/ jsx_runtime_.jsx("input", {
                    type: "number",
                    min: 100,
                    max: 100000,
                    value: props.modelConfig.max_tokens,
                    onChange: (e)=>props.updateConfig((config)=>config.max_tokens = store/* ModalConfigValidator */.Xm.max_tokens(e.currentTarget.valueAsNumber))
                })
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* ListItem */.HC, {
                title: locales/* default */.ZP.Settings.PresencePenalty.Title,
                subTitle: locales/* default */.ZP.Settings.PresencePenalty.SubTitle,
                children: /*#__PURE__*/ jsx_runtime_.jsx(input_range/* InputRange */.O, {
                    ...
                    step: "0.1",
                    onChange: (e)=>{
                        props.updateConfig((config)=>config.presence_penalty = store/* ModalConfigValidator */.Xm.presence_penalty(e.currentTarget.valueAsNumber));
                    }
                })
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* ListItem */.HC, {
                title: locales/* default */.ZP.Settings.FrequencyPenalty.Title,
                subTitle: locales/* default */.ZP.Settings.FrequencyPenalty.SubTitle,
                children: /*#__PURE__*/ jsx_runtime_.jsx(input_range/* InputRange */.O, {
                    ...
                    step: "0.1",
                    onChange: (e)=>{
                        props.updateConfig((config)=>config.frequency_penalty = store/* ModalConfigValidator */.Xm.frequency_penalty(e.currentTarget.valueAsNumber));
                    }
                })
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* ListItem */.HC, {
                title: locales/* default */.ZP.Settings.InjectSystemPrompts.Title,
                subTitle: locales/* default */.ZP.Settings.InjectSystemPrompts.SubTitle,
                children: /*#__PURE__*/ jsx_runtime_.jsx("input", {
                    type: "checkbox",
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* ListItem */.HC, {
                title: locales/* default */.ZP.Settings.InputTemplate.Title,
                subTitle: locales/* default */.ZP.Settings.InputTemplate.SubTitle,
                children: /*#__PURE__*/ jsx_runtime_.jsx("input", {
                    type: "text",
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* ListItem */.HC, {
                title: locales/* default */.ZP.Settings.HistoryCount.Title,
                subTitle: locales/* default */.ZP.Settings.HistoryCount.SubTitle,
                children: /*#__PURE__*/ jsx_runtime_.jsx(input_range/* InputRange */.O, {
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* ListItem */.HC, {
                title: locales/* default */.ZP.Settings.CompressThreshold.Title,
                subTitle: locales/* default */.ZP.Settings.CompressThreshold.SubTitle,
                children: /*#__PURE__*/ jsx_runtime_.jsx("input", {
                    type: "number",
                    min: 500,
                    max: 4000,
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* ListItem */.HC, {
                title: locales/* default */.ZP.Memory.Title,
                subTitle: locales/* default */.ZP.Memory.Send,
                children: /*#__PURE__*/ jsx_runtime_.jsx("input", {
                    type: "checkbox",
...
function MaskConfig(props) {
    ...
    const copyMaskLink = ()=>{
        const maskLink = `${location.protocol}//${location.host}/#${constant/* Path */.y$.NewChat}?mask=${props.mask._id}`;
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)(ui_lib/* List */.aV, {
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx(ModelConfigList, {
                        modelConfig: {
                            ...props.mask.modelConfig
                        },
