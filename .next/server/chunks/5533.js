...
/* harmony export */ });
/* harmony import */ var _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(70106);
...
function preprocessMarkdown(markdown) {
  ...
  const withoutExtraSpaces = (0,ts_dedent__WEBPACK_IMPORTED_MODULE_0__/* .dedent */ .Zc)(withoutMultipleNewlines);
...
const createText = (el, text = "", {
  ...
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_2__.l.info("createText", text, style, isTitle, classes, useHtmlLabels, isNode, addSvgBackground);
  if (useHtmlLabels) {
    const htmlText = markdownToHTML(text);
    const node = {
      isNode,
      label: (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_2__.I)(htmlText).replace(
        /fa[blrs]?:fa-[\w-]+/g,
