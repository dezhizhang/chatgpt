...
// EXTERNAL MODULE: ./app/api/request.ts
var request = __webpack_require__(75918);
;// CONCATENATED MODULE: ./app/api/chat.ts
/*
 * :file description: 
 ...
 */ 
// 获取模型列表
const getModelList = ()=>(0,request/* GET */.HT)("/model/list");
// 初始化模型
const getChatInit = (params)=>GET("/chat/init", params);
...
var components_mask = __webpack_require__(83891);
...
var masks = __webpack_require__(20918);
...
function NewChat() {
    ...
    (0,command/* useCommand */.YZ)({
        mask: (id)=>{
            try {
                const mask = maskStore.get(id) ?? masks/* BUILTIN_MASK_STORE */.$n.get(id);
