...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/mermaid-306576ad.js + 8 modules
var mermaid_306576ad = __webpack_require__(70106);
...
var dagre = __webpack_require__(60385);
...
;// CONCATENATED MODULE: ./node_modules/mermaid/dist/erDiagram-105a1cb2.js
...
const parseDirective = function(statement, context, type) {
  mermaid_306576ad.m.parseDirective(this, statement, context, type);
};
const addEntity = function(name) {
  if (entities[name] === void 0) {
    entities[name] = { attributes: [] };
    mermaid_306576ad.l.info("Added new entity :", name);
  }
...
const addAttributes = function(entityName, attribs) {
  ...
  for (i = attribs.length - 1; i >= 0; i--) {
    ...
    mermaid_306576ad.l.debug("Added attribute ", attribs[i].attributeName);
  }
};
const addRelationship = function(entA, rolA, entB, rSpec) {
  ...
  mermaid_306576ad.l.debug("Added new relationship :", rel);
};
const getRelationships = () => relationships;
const clear = function() {
  entities = {};
  relationships = [];
  (0,mermaid_306576ad.v)();
};
const erDb = {
  Cardinality,
  Identification,
  parseDirective,
  getConfig: () => (0,mermaid_306576ad.c)().er,
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
  getRelationships,
  clear,
  setAccTitle: mermaid_306576ad.s,
  getAccTitle: mermaid_306576ad.g,
  setAccDescription: mermaid_306576ad.b,
  getAccDescription: mermaid_306576ad.a,
  setDiagramTitle: mermaid_306576ad.r,
  getDiagramTitle: mermaid_306576ad.t
};
const ERMarkers = {
...
const drawAttributes = (groupNode, entityTextNode, attributes) => {
  ...
  attributes.forEach((item) => {
    ...
    let nodeHeight = 0;
    const attributeType = (0,mermaid_306576ad.x)(item.attributeType);
    const typeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,mermaid_306576ad.c)().fontFamily).style("font-size", attrFontSize + "px").text(attributeType);
    const nameNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-name`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,mermaid_306576ad.c)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeName);
    const attributeNode = {};
    ...
    if (hasKeyType) {
      ...
      const keyTypeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,mermaid_306576ad.c)().fontFamily).style("font-size", attrFontSize + "px").text(keyTypeNodeText);
    ...
    if (hasComment) {
      const commentNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-comment`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,mermaid_306576ad.c)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeComment || "");
...
const drawEntities = function(svgNode, entities2, graph) {
  ...
  keys.forEach(function(entityName) {
    ...
    const textNode = groupNode.append("text").classed("er entityLabel", true).attr("id", textId).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", (0,mermaid_306576ad.c)().fontFamily).style("font-size", conf.fontSize + "px").text(entityName);
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  const labelNode = svg.append("text").classed("er relationshipLabel", true).attr("id", labelId).attr("x", labelPoint.x).attr("y", labelPoint.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", (0,mermaid_306576ad.c)().fontFamily).style("font-size", conf.fontSize + "px").text(rel.roleA);
...
const draw = function(text, id, _version, diagObj) {
  conf = (0,mermaid_306576ad.c)().er;
  mermaid_306576ad.l.info("Drawing ER diagram");
  const securityLevel = (0,mermaid_306576ad.c)().securityLevel;
  let sandboxElement;
  ...
  mermaid_306576ad.u.insertTitle(svg, "entityTitleText", conf.titleTopMargin, diagObj.db.getDiagramTitle());
  const svgBounds = svg.node().getBBox();
  const width = svgBounds.width + padding * 2;
  const height = svgBounds.height + padding * 2;
  (0,mermaid_306576ad.i)(svg, height, width, conf.useMaxWidth);
