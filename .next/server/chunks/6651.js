...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/index-892ad7fb.js
var index_892ad7fb = __webpack_require__(97841);
...
;// CONCATENATED MODULE: ./node_modules/mermaid/dist/styles-4fcf332f.js
...
const addVertices = function(vert, g, svgId, root, doc, diagObj) {
  ...
  keys.forEach(function(id) {
    ...
    const styles = (0,mermaid_306576ad.k)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    mermaid_306576ad.l.info("vertex", vertex, vertex.labelType);
    if (vertex.labelType === "markdown") {
      mermaid_306576ad.l.info("vertex", vertex, vertex.labelType);
    } else {
      if ((0,mermaid_306576ad.n)((0,mermaid_306576ad.c)().flowchart.htmlLabels)) {
        const node = {
        ...
        const rows = vertexText.split(mermaid_306576ad.e.lineBreakRegex);
    ...
    g.setNode(vertex.id, {
      ...
      type: vertex.type,
      props: vertex.props,
      padding: (0,mermaid_306576ad.c)().flowchart.padding
    });
    mermaid_306576ad.l.info("setNode", {
      labelStyle: styles.labelStyle,
      labelType: vertex.labelType,
      shape: _shape,
      labelText: vertexText,
...
const addEdges = function(edges, g, diagObj) {
  mermaid_306576ad.l.info("abc78 edges = ", edges);
  let cnt = 0;
  let linkIdCnt = {};
  let defaultStyle;
  let defaultLabelStyle;
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,mermaid_306576ad.k)(edges.defaultStyle);
  ...
  edges.forEach(function(edge) {
    ...
    if (linkIdCnt[linkIdBase] === void 0) {
      ...
      mermaid_306576ad.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    } else {
      linkIdCnt[linkIdBase]++;
      mermaid_306576ad.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    }
    let linkId = linkIdBase + "-" + linkIdCnt[linkIdBase];
    mermaid_306576ad.l.info("abc78 new link id to be used is", linkIdBase, linkId, linkIdCnt[linkIdBase]);
    ...
    if (edge.style !== void 0) {
      const styles = (0,mermaid_306576ad.k)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    }
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,mermaid_306576ad.o)(edge.interpolate, src/* curveLinear */.c_6);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,mermaid_306576ad.o)(edges.defaultInterpolate, src/* curveLinear */.c_6);
    } else {
      edgeData.curve = (0,mermaid_306576ad.o)(conf.curve, src/* curveLinear */.c_6);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
    ...
    edgeData.label = edge.text.replace(mermaid_306576ad.e.lineBreakRegex, "\n");
    if (edge.style === void 0) {
...
const draw = async function(text, id, _version, diagObj) {
  mermaid_306576ad.l.info("Drawing flowchart");
  let dir = diagObj.db.getDirection();
  if (dir === void 0) {
    dir = "TD";
  }
  const { securityLevel, flowchart: conf2 } = (0,mermaid_306576ad.c)();
  ...
  mermaid_306576ad.l.info("Subgraphs - ", subGraphs);
  for (let i2 = subGraphs.length - 1; i2 >= 0; i2--) {
    subG = subGraphs[i2];
    mermaid_306576ad.l.info("Subgraph - ", subG);
  ...
  mermaid_306576ad.l.info("Edges", edges);
  let i = 0;
  for (i = subGraphs.length - 1; i >= 0; i--) {
    subG = subGraphs[i];
    (0,src/* selectAll */.td_)("cluster").append("text");
    for (let j = 0; j < subG.nodes.length; j++) {
      mermaid_306576ad.l.info("Setting up subgraphs", subG.nodes[j], subG.id);
  ...
  await (0,index_892ad7fb.r)(element, g, ["point", "circle", "cross"], "flowchart", id);
  mermaid_306576ad.u.insertTitle(svg, "flowchartTitleText", conf2.titleTopMargin, diagObj.db.getDiagramTitle());
  (0,mermaid_306576ad.p)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
