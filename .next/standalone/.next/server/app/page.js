...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 895)), "/Users/zhangdezhi/Documents/project/chatgpt/app/page.tsx"],
          
        }]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5818)), "/Users/zhangdezhi/Documents/project/chatgpt/app/layout.tsx"],
...
var client = __webpack_require__(9463);
// EXTERNAL MODULE: ./app/constant.ts
var constant = __webpack_require__(3684);
...
var locales = __webpack_require__(6151);
...
class ClientApi {
    ...
    async share(messages, avatarUrl = null) {
        const msgs = messages.map((m)=>({
            ...
            {
                from: "human",
                value: "Share from [晓智gpt]: https://github.com/Yidadaa/ChatGPT-Next-Web"
            }
        ]);
...
/* harmony import */ var _button_module_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3162);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8038);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _button__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9378);
...
/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3684);
/* harmony import */ var _locales__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6151);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(2842);
/* harmony import */ var _ui_lib__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(4552);
...
var components_button = __webpack_require__(9378);
...
var ui_lib = __webpack_require__(4552);
...
var store_config = __webpack_require__(1472);
// EXTERNAL MODULE: ./app/components/auth.module.scss
var auth_module = __webpack_require__(3993);
var auth_module_default = /*#__PURE__*/__webpack_require__.n(auth_module);
;// CONCATENATED MODULE: ./app/components/auth.tsx
...
function AuthPage() {
    ...
    const goHome = ()=>navigate(constant/* Path */.y$.Home);
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: (auth_module_default())["auth-page"],
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: `no-dark ${(auth_module_default())["auth-logo"]}`,
                children: /*#__PURE__*/ jsx_runtime_.jsx(bot/* default */.Z, {})
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: (auth_module_default())["auth-title"],
                children: locales/* default */.ZP.Auth.Title
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: (auth_module_default())["auth-tips"],
                children: locales/* default */.ZP.Auth.Tips
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("input", {
                className: (auth_module_default())["auth-input"],
                type: "password",
                placeholder: locales/* default */.ZP.Auth.Input,
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: (auth_module_default())["auth-actions"],
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
                        text: locales/* default */.ZP.Auth.Confirm,
                        type: "primary",
                        onClick: goHome
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
                        text: locales/* default */.ZP.Auth.Later,
                        onClick: goHome
                    })
                ]
            })
...
var api = __webpack_require__(9282);
...
function Screen() {
    ...
    const isAuth = location.pathname === constant/* Path */.y$.Auth;
    const isMobileScreen = (0,utils/* useMobileScreen */.S0)();
    (0,react_.useEffect)(()=>{
        loadAsyncGoogleFont();
    }, []);
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: (home_module_default()).container + ` ${config.tightBorder && !isMobileScreen ? (home_module_default())["tight-container"] : (home_module_default()).container} ${(0,locales/* getLang */.VQ)() === "ar" ? (home_module_default())["rtl-screen"] : ""}`,
        children: isAuth ? /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
            children: /*#__PURE__*/ jsx_runtime_.jsx(AuthPage, {})
...
var ui_lib_module = __webpack_require__(3259);
...
var icons_confirm = __webpack_require__(7365);
// EXTERNAL MODULE: ./app/icons/cancel.svg
var cancel = __webpack_require__(2064);
// EXTERNAL MODULE: ./app/icons/max.svg
var max = __webpack_require__(9746);
// EXTERNAL MODULE: ./app/icons/min.svg
var min = __webpack_require__(3380);
// EXTERNAL MODULE: ./app/locales/index.ts + 17 modules
var locales = __webpack_require__(6151);
...
function Selector(props) {
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: (ui_lib_module_default()).selector,
        onClick: ()=>props.onClose?.(),
        children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
            className: (ui_lib_module_default())["selector-content"],
            children: /*#__PURE__*/ jsx_runtime_.jsx(List, {
                children: props.items.map((item, i)=>{
                    ...
                    return /*#__PURE__*/ jsx_runtime_.jsx(ListItem, {
                        className: (ui_lib_module_default())["selector-item"],
                        title: item.title,
                        ...
                        children: selected ? /*#__PURE__*/ jsx_runtime_.jsx("div", {
                            style: {
                                height: 10,
                                width: 10,
...
// EXTERNAL MODULE: ./app/store/config.ts
var config = __webpack_require__(1472);
...
const jp = {
    ...
    Mask: {
        ...
        EditModal: {
            Title: (readonly)=>`キャラクタープリセットを編集 ${readonly ? "（読み取り専用）" : ""}`,
            Download: "ダウンロード",
            Clone: "複製"
        },
        Config: {
...
;// CONCATENATED MODULE: ./app/locales/no.ts
...
const no = {
    ...
    ChatItem: {
        ChatItemCount: (count)=>`${count} meldinger`
    },
    Chat: {
        SubTitle: (count)=>`${count} meldinger med ChatGPT`,
        Actions: {
    ...
    Settings: {
        ...
        Update: {
            ...
            FoundUpdate: (x)=>`Fant ny versjon: ${x}`,
            GoToUpdate: "Oppdater"
        },
        ...
        Prompt: {
            ...
            List: "Instruksliste",
            ListCount: (builtin, custom)=>`${builtin} innebygde, ${custom} brukerdefinerte`,
            Edit: "Endre",
            Modal: {
                Title: "Instruksliste",
                Add: "Legg til",
        ...
        Token: {
            Title: "API Key",
            SubTitle: "Bruk din egen API-n\xf8kkel for \xe5 ignorere tilgangskoden begrensning",
        ...
        AccessCode: {
            Title: "Tilgangskode",
            SubTitle: "Tilgangskontroll p\xe5",
    ...
    Context: {
        Toast: (x)=>`Med ${x} kontekstuelle instrukser`,
...
/* harmony default export */ const locales_no = (no);
...
;// CONCATENATED MODULE: ./app/locales/ar.ts
...
const ar = {
    ...
    ChatItem: {
        ChatItemCount: (count)=>`${count} رسائل`
    },
    Chat: {
        SubTitle: (count)=>` ${count} رسائل مع ChatGPT`,
        Actions: {
...
${builtin} مدمجة، ${custom} تم تعريفها من قبل المستخدم`,
    ...
    Mask: {
        ...
        Page: {
            Title: "قالب الاقتراح",
            SubTitle: (count)=>`${count} قوالب الاقتراح`,
            Search: "البحث في القوالب",
            Create: "إنشاء"
        },
        Item: {
            Info: (count)=>`${count} اقتراحات`,
            Chat: "الدردشة",
            View: "عرض",
            Edit: "تعديل",
            Delete: "حذف",
...
/* harmony default export */ const locales_ar = (ar);

;// CONCATENATED MODULE: ./app/locales/bn.ts
...
const bn = {
    ...
    ChatItem: {
        ChatItemCount: (count)=>`${count} টি বার্তা`
    },
    Chat: {
        SubTitle: (count)=>`${count} টি বার্তা`,
        Actions: {
    ...
    Mask: {
        ...
        Page: {
            ...
            SubTitle: (count)=>`${count} টি প্রম্পট টেমপ্লেট`,
            Search: "টেমপ্লেট অনুসন্ধান করুন",
            Create: "তৈরি করুন"
        },
        Item: {
            Info: (count)=>`${count} প্রম্পট`,
            Chat: "চ্যাট",
            View: "দেখুন",
            Edit: "সম্পাদন করুন",
            Delete: "মুছে ফেলুন",
        ...
        EditModal: {
            Title: (readonly)=>`প্রম্পট টেমপ্লেট সম্পাদন করুন ${readonly ? "(readonly)" : ""}`,
            Download: "ডাউনলোড করুন",
            Clone: "ক্লোন করুন"
        },
        Config: {
...
/* harmony default export */ const locales_bn = (bn);
...
var mask = __webpack_require__(3706);
// EXTERNAL MODULE: ./app/constant.ts
var constant = __webpack_require__(3684);
// EXTERNAL MODULE: ./app/client/api.ts + 1 modules
var api = __webpack_require__(9282);
// EXTERNAL MODULE: ./app/client/controller.ts
var client_controller = __webpack_require__(2564);
// EXTERNAL MODULE: ./app/utils/format.ts
var format = __webpack_require__(4643);
...
var nanoid = __webpack_require__(5667);
        ...
        async onUserInput (content) {
            ...
            api/* api */.hi.llm.chat({
                ...
                onFinish (message) {
                    ...
                    client_controller/* ChatControllerPool */.L.remove(session.id, botMessage.id);
                },
                onError (error) {
                    ...
                    client_controller/* ChatControllerPool */.L.remove(session.id, botMessage.id ?? messageIndex);
                    console.error("[Chat] failed ", error);
                },
                onController (controller) {
                    // collect controller for stop/retry
                    client_controller/* ChatControllerPool */.L.addController(session.id, botMessage.id ?? messageIndex, controller);
                }
            });
        },
        getMemoryPrompt () {
    ...
    migrate (persistedState, version) {
        ...
        if (version < 3) {
            ...
            newState.sessions.forEach((s)=>{
                s.id = (0,nanoid/* nanoid */.x0)();
                s.messages.forEach((m)=>m.id = (0,nanoid/* nanoid */.x0)());
            });
        }
...
/* harmony import */ var _config_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9463);
/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3684);
...
// UNUSED EXPORTS: DEFAULT_CONFIG, limitNumber

// EXTERNAL MODULE: ./app/store/chat.ts + 1 modules
var chat = __webpack_require__(6085);
// EXTERNAL MODULE: ./node_modules/zustand/esm/index.mjs + 1 modules
var esm = __webpack_require__(3998);
// EXTERNAL MODULE: ./node_modules/zustand/esm/middleware.mjs
var middleware = __webpack_require__(8658);
...
const DEFAULT_OPENAI_URL = (0,client/* getClientConfig */.Z)()?.buildMode === "export" ? constant/* DEFAULT_API_HOST */.Ky : "/api/openai/";
...
const useAccessStore = (0,esm/* create */.Ue)()((0,middleware/* persist */.tJ)((set, get)=>({
        ...
        fetch () {
            ...
            fetch("/api/config", {
                ...
                if (res.disableGPT4) {
                    constant/* DEFAULT_MODELS */.Fv.forEach((m)=>m.available = !m.name.startsWith("gpt-4"));
                }
            }).catch(()=>{
...
/* harmony import */ var zustand__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3998);
/* harmony import */ var zustand_middleware__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8658);
/* harmony import */ var _masks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8586);
/* harmony import */ var _locales__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6151);
/* harmony import */ var _chat__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6085);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1472);
/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3684);
/* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(5667);
...
const useMaskStore = (0,zustand__WEBPACK_IMPORTED_MODULE_6__/* .create */ .Ue)()((0,zustand_middleware__WEBPACK_IMPORTED_MODULE_7__/* .persist */ .tJ)((set, get)=>({
    ...
    migrate (state, version) {
        ...
        if (version < 3) {
            Object.values(newState.masks).forEach((m)=>m.id = (0,nanoid__WEBPACK_IMPORTED_MODULE_5__/* .nanoid */ .x0)());
        }
        if (version < 3.1) {
            const updatedMasks = {};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8038);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_ui_lib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4552);
/* harmony import */ var _locales__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6151);
...
var react = __webpack_require__(7159);
...
var spark_md5 = __webpack_require__(6033);
...
var __webpack_exports__ = __webpack_require__.X(0, [4361], () => (__webpack_exec__(5936)));
